...
!(function (t, e) {
  ...
  function de(t, e) {
    return (
      (t = Se(t)),
      P(e) ? t.innerHTML : fe(t.hasChildNodes() ? le(t) : t, e)
    );
  }
  function fe(e, t) {
    return (
      ...
      computed: {
        props: function (m, g) {
          ...
          return Vr.reduce(function (t, e) {
            ...
            return (
              (t[e] = { steps: a, unit: h, pos: n, bgPos: i, diff: r }),
              t
            );
          }, {});
        },
      ...
      data: {
        ...
        Transitioner: function (r, i, o, t) {
          ...
          return {
            ...
            percent: function () {
              return Math.abs(
                (He(a, "transform").split(",")[4] * (at ? -1 : 1) + n) /
                  (c - n),
              );
            },
            getDistance: function () {
